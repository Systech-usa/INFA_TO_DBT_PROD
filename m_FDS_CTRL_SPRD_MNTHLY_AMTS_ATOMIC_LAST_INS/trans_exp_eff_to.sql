...
trans_exp_eff_to as (
    select
        ...
        iff(in_eff_to_tistmp = eff_fm_tistmp OR TO_CHAR(in_eff_to_tistmp, 'YYYY-MM-DD HH24:MI:SS') = '1900-01-01 00:00:00' OR TO_CHAR(in_eff_to_tistmp, 'YYYY-MM-DD HH24:MI:SS') = 
'2999-12-31 00:00:00'  , in_eff_to_tistmp,ADD_TO_DATE(in_eff_to_tistmp,'DD',-1)) as out_eff_to_tistmp
