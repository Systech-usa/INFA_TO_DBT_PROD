...
trans_exp_trl_sprd_2yr_last_mnth as (
    select
        ...
        sq.monthly_date as monthly_date,
        ...
        sq.prem_added_amt as prem_added_amt,
        ROUND( ( ( trl_sprd_2yr_base_amt - iff(prem_added_amt is null, 0, prem_added_amt) )  +  (trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_dly_amt)  ), 2 ) as out_prem_amt,
        ...
        sq.der_comm_added_amt as der_comm_added_amt,
        ROUND( ( ( trl_sprd_2yr_comm_amt - iff(der_comm_added_amt is null, 0, der_comm_added_amt) )  +  ( trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_comm_dly_amt) ), 2 ) as out_der_comm_amt,
        ...
        sq.der_tran_prem_added_amt as der_tran_prem_added_amt,
        ROUND( ( ( trl_sprd_2yr_tran_prem_amt-iff(der_tran_prem_added_amt is null, 0, der_tran_prem_added_amt) )  +  ( trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_tran_prem_dly_amt) ), 2 ) as out_der_tran_prem_amt,
        ...
        sq.der_tran_comm_added_amt as der_tran_comm_added_amt,
        ROUND( ( ( out_trl_sprd_2yr_tran_comm_amt-iff(der_tran_comm_added_amt is null, 0, der_tran_comm_added_amt) )  +  ( trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_tran_comm_dly_amt) ), 2 ) as out_der_tran_comm_amt,
        ...
        sq.der_contr_prem_added_amt as der_contr_prem_added_amt,
        ROUND( ( ( trl_sprd_2yr_contr_prem_amt - iff(der_contr_prem_added_amt is null, 0, der_contr_prem_added_amt) )  +  ( trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_contr_prem_dly_amt) ), 2 ) as out_der_contr_prem_amt,
        ...
        sq.der_contr_comm_added_amt as der_contr_comm_added_amt,
        ROUND( ( ( trl_sprd_2yr_contr_comm_amt - iff(der_contr_comm_added_amt is null, 0, der_contr_comm_added_amt) )  +  ( trl_sprd_2yr_last_mnth_rem_days * trl_sprd_rem_term_contr_comm_dly_amt) ), 2 ) as out_der_contr_comm_amt,
