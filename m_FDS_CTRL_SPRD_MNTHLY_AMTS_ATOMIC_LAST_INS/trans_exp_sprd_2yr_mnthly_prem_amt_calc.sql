...
trans_exp_sprd_2yr_mnthly_prem_amt_calc as (
    select
        ...
        sq.in_org_eff_to_tistmp as in_org_eff_to_tistmp,
        -- Commented as part of CR#93
--iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
-- (ROUND(v_days_in_mnth  * daily_amt,2)),(ROUND(base_amt,2))) 
...
iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
       ...
       (ROUND(base_amt,2))
        ...
        -- Commented as part of CR#93
--iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
-- (ROUND(v_days_in_mnth  * in_comm_daily_amt,2)),(ROUND(in_comm_amt,2)))
-- Changed as below as part of CR#93
iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
        iff(v_trl_sprd_ind = 0, 
       ...
       (ROUND(in_comm_amt,2))
        ...
        -- Commented as part of CR#93
--iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to= 1 , 
-- (ROUND(v_days_in_mnth * in_dly_tran_prem_amt ,2)), (ROUND(in_tran_prem_amt,2)))
-- Changed as below as part of CR#93
iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
        iff(v_trl_sprd_ind = 0, 
       ...
       (ROUND(in_tran_prem_amt,2))
        ...
        -- Commented as part of CR#93
--iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
-- (ROUND(v_days_in_mnth * in_dly_tran_comm_amt ,2)), (ROUND(in_tran_comm_amt ,2))) 
-- Changed as below as part of CR#93
iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
        iff(v_trl_sprd_ind = 0, 
...
iff( v_chk_mnth_part_fm = 1 OR v_chk_mnth_part_to =1,
       ...
       (ROUND(in_contr_comm_amt,2))
        ...
        sq.v_trl_sprd_rem_term_comm_dly_amt as v_trl_sprd_rem_term_comm_dly_amt,
        sq.v_trl_sprd_2yr_tran_prem_dly_amt as v_trl_sprd_2yr_tran_prem_dly_amt,
        sq.v_trl_sprd_rem_term_tran_prem_dly_amt as v_trl_sprd_rem_term_tran_prem_dly_amt,
        sq.v_trl_sprd_2yr_tran_comm_dly_amt as v_trl_sprd_2yr_tran_comm_dly_amt,
        sq.v_trl_sprd_rem_term_tran_comm_dly_amt as v_trl_sprd_rem_term_tran_comm_dly_amt,
        sq.v_trl_sprd_2yr_contr_prem_dly_amt as v_trl_sprd_2yr_contr_prem_dly_amt,
        sq.v_trl_sprd_rem_term_contr_prem_dly_amt as v_trl_sprd_rem_term_contr_prem_dly_amt,
        sq.v_trl_sprd_2yr_contr_comm_dly_amt as v_trl_sprd_2yr_contr_comm_dly_amt,
        sq.v_trl_sprd_rem_term_contr_comm_dly_amt as v_trl_sprd_rem_term_contr_comm_dly_amt,
        sq.v_trl_sprd_ind as v_trl_sprd_ind,
