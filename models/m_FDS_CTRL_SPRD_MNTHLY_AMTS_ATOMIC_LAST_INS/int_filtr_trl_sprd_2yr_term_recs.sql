...
int_filtr_trl_sprd_2yr_term_recs as (
    ...
    from trans_exp_sprd_mnthly_prem_amt_calc exp
    left join stg_sq_ctrl_sprd_mnthly_amts_temp1 sq
        on exp.prtclr_mony_provsn_id = sq.prtclr_mony_provsn_id
       and exp.agmt_anchr_id = sq.agmt_anchr_id
       and exp.eff_fm_tistmp = sq.eff_fm_tistmp
    where exp.v_trl_sprd_ind = 1 
      and sq.out_mnth_yr_part_last_day <= exp.v_mnth_yr_part_trl_sprd_2yr_last_day
)
