...
joined_data as (
    select 
        ...
        exp.contr_crcy_cd,
        exp.v_exp_date_diff
    from stg_sq_ctrl_sprd_mnthly_amts_temp sq
    left join trans_exp_sprd_2yr_mnthly_prem_amt_calc exp
        on sq.prtclr_mony_provsn_id = exp.prtclr_mony_provsn_id
        and sq.agmt_anchr_id = exp.agmt_anchr_id
        and sq.eff_fm_tistmp = exp.eff_fm_tistmp
),
