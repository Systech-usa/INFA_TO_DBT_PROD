-- int_filt_not_trl_sprd_2yr_last_mnth.sql
...
int_filt_not_trl_sprd_2yr_last_mnth as (
    select
        ...
        trans.out_der_comm_amt,
        sq.in_tran_prem_amt as out_tran_prem_amt,
        sq.in_tran_comm_amt as tran_comm_amt,
        trans.out_der_tran_prem_amt,
        trans.out_der_tran_comm_amt,
        ...
        trans.out_der_contr_prem_amt,
        trans.src_ln_of_busn_cd,
        ...
        trans.out_der_contr_comm_amt,
        trans.crcy_cd,
        trans.tran_crcy_cd,
        trans.contr_crcy_cd,
        trans.v_exp_date_diff
    from trans_exp_sprd_2yr_mnthly_prem_amt_calc as trans
    left join stg_sq_ctrl_sprd_mnthly_amts_temp as sq
        on trans.prtclr_mony_provsn_id = sq.prtclr_mony_provsn_id
        and trans.agmt_anchr_id = sq.agmt_anchr_id
        and trans.eff_fm_tistmp = sq.eff_fm_tistmp
