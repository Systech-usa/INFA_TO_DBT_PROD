...
with int_filt_not_trl_sprd_2yr_last_mnth as (
...
not_trl_sprd_2yr_last_mnth as (
    ...
    from int_filt_not_trl_sprd_2yr_last_mnth
),
...
trl_sprd_2yr_last_mnth as (
    select 
        ...
        tran_crcy_cd as tran_crcy_cd,
        contr_crcy_cd as contr_crcy_cd
    from trans_exp_trl_sprd_2yr_last_mnth
),

int_union_all_recs as (
    select * from not_trl_sprd_2yr_last_mnth
    union all
    select * from trl_sprd_2yr_last_mnth
)

select * from int_union_all_recs
--End-DBShift