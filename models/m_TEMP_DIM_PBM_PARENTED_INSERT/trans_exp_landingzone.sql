...
trans_exp_landingzone as (
    select
        ...
        decode(sq.pbm_hub_sk,NULL,sq.ods_batch_id,sq.crt_batch_id) as o_crt_batchid,
        decode(sq.pbm_hub_sk,NULL,sq.ods_batch_row_id,sq.crt_batch_row_id) as o_crt_batch_row_id,
        current_timestamp() as o_crt_tmsp,
        decode(sq.pbm_hub_sk,NULL,NULL,sq.crt_batch_id) as o_upd_batchid,
        decode(sq.pbm_hub_sk,NULL,NULL,sq.crt_batch_row_id) as o_upd_batch_row_id,
        decode(sq.pbm_hub_sk,NULL,NULL,sq.crt_tmsp) as o_upd_tmsp,
        decode(sq.pbm_hub_sk,NULL,NULL,'Changed at Source') as o_upd_user,
        sq.pbm_hub_hk as o_pbm_hub_hk,
